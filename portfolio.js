...
// Start Contact Part
    ...
    $('#submit').click(function() {
        if($.trim($('#name').val()) === ''){
            $('#name').next('div').fadeIn(100).delay(1500).fadeOut(100);
        } else if ($.trim($('#email').val()) === ''){
            $('#email').next('div').fadeIn(100).delay(1500).fadeOut(100);
         } else {
            $('input').parent().siblings('div').fadeIn(100).delay(5000).fadeOut(100);
        }
    })
